...
const diveSites: DiveSite[] = [
    ...
    { location: "Tulum - Cenote Yax-Kin", latitude: 20.215, longitude: -87.47, dive_count: 1, region: "Mexico", notes: "Cenote dive near Tulum" },
    ...
    { location: "Kona - Garden Eel Cove", latitude: 19.736, longitude: -156.054, dive_count: 3, region: "USA", notes: "Makako Bay, off Kona Airport" },
    ...
    { location: "Kona - Manta Heaven (Night)", latitude: 19.736, longitude: -156.054, dive_count: 2, region: "USA", notes: "Manta Heaven, Makako Bay - record number of mantas" },
    ...
    { location: "Nha Trang - Cemetery Bay, Vietnam", latitude: 12.168, longitude: 109.309, dive_count: 1, region: "Vietnam", notes: "Hon Mun Marine Park" },
    { location: "Nha Trang - Hon Mun Marine Park, Vietnam", latitude: 12.168, longitude: 109.309, dive_count: 1, region: "Vietnam", notes: "Hon Mun Marine Park" },
    ...
    { location: "Key Largo - North Star", latitude: 25.087, longitude: -80.447, dive_count: 1, region: "USA", notes: "Key Largo reef dive" },
    { location: "Key Largo - Hole In The Wall", latitude: 25.087, longitude: -80.447, dive_count: 1, region: "USA", notes: "Key Largo reef dive" },
    ...
    { location: "Key Largo - Minnow Cave", latitude: 25.087, longitude: -80.447, dive_count: 1, region: "USA", notes: "Key Largo cave dive" },
