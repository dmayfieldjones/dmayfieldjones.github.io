        ...
        <section className="offspring-section">
          ...
          <div className="puppies-list">
            <div className="puppy-card">
              <p className="puppy-reg">AKC Registration: WS81418801</p>
            ...
            <div className="puppy-card">
              <p className="puppy-reg">AKC Registration: WS81418802</p>
              <p className="puppy-name">
            ...
            <div className="puppy-card">
              <p className="puppy-reg">AKC Registration: WS81418803</p>
              <p className="puppy-name">
            ...
            <div className="puppy-card">
              <p className="puppy-reg">AKC Registration: WS81418804</p>
              <p className="puppy-name">
            ...
            <div className="puppy-card">
              <p className="puppy-reg">AKC Registration: WS81418805</p>
              <p className="puppy-name">
